...
HD_PWD='F:/CompArch/FPGA_Lab/Lab10/project_2/project_2.runs/design_1_mult_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_mult_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_mult_gen_0_0.tcl
