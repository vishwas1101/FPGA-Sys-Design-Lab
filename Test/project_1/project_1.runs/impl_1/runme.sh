...
HD_PWD='F:/CompArch/FPGA_Lab/Test/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log testfile.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source testfile.tcl -notrace
