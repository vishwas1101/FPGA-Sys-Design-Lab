...
HD_PWD='F:/CompArch/FPGA_Lab/Test/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testfile.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testfile.tcl
