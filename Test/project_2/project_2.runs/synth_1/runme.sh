...
HD_PWD='F:/CompArch/FPGA_Lab/Test/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log countfsm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source countfsm.tcl
