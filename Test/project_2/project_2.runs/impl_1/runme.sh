...
HD_PWD='F:/CompArch/FPGA_Lab/Test/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log countfsm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source countfsm.tcl -notrace
