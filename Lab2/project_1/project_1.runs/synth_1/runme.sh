...
HD_PWD='F:/CompArch/FPGA_Lab/Lab2/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Counter_N.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Counter_N.tcl
