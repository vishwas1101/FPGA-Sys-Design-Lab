...
HD_PWD='F:/CompArch/FPGA_Lab/Lab2/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Counter_N.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Counter_N.tcl -notrace
