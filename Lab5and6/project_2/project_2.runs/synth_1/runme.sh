...
HD_PWD='F:/CompArch/FPGA_Lab/Lab5and6/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Car_FSM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Car_FSM.tcl
