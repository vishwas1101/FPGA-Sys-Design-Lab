...
HD_PWD='F:/CompArch/FPGA_Lab/Lab5and6/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Car_FSM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Car_FSM.tcl -notrace
