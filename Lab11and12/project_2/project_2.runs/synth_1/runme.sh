...
HD_PWD='F:/CompArch/FPGA_Lab/Lab11and12/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_alu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_alu.tcl
