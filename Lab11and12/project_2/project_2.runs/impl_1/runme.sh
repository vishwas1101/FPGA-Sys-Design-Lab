...
HD_PWD='F:/CompArch/FPGA_Lab/Lab11and12/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log main_alu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source main_alu.tcl -notrace
